...
<head>
    <meta charset="utf-8">
    <title>Rekap Bulanan Presensi Sholat</title>
    <style>
        body {
...
<body>
    <h1>REKAP BULANAN PRESENSI SHOLAT JAMAAH</h1>
    <h2>Periode: {{ $month }}</h2>
    ...
    <div class="footer">
        <p>Dicetak pada: {{ \Carbon\Carbon::now()->locale('id')->format('d F Y, H:i') }} WIB</p>
        <p><strong>Sistem Informasi Santri - SISANTRI</strong></p>
    </div>
</body>
</html>
